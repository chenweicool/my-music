  ...
  <div>
    ...
    <el-card>
      <el-table :data="tableData" border default-expand-all stripe style="width: 100%;margin-bottom: 20px;">
        ...
        <el-table-column label="评论的状态" width="50" align="center">
            <template slot-scope="scope">
                <div>{{changeCommitStatus(scope.row.commentStatus) }}</div>
            </template>
          </el-table-column>
...
<script>
  ...
  created () {
    ...
    changeCommitStatus(val){
           return dateUtils.changeCommit(val);
    }
  },
  }
</script>
