<template>
    <div>
              ...
              <el-button type="primary"  plain @click="myHistory()" >我的浏览历史</el-button>
              <el-button type="primary"  plain @click="myCreateSongList()">我的创建歌单</el-button>
              <el-button type="primary"  plain @click="myListenStatistic()">我的听歌统计</el-button>
