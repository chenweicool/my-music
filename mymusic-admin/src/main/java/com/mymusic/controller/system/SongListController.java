...
public class SongListController {
    ...
    @RequestMapping("/getTotalSongList")
    public AjaxResponse getTotalSongList() {
        Long totalSongList = songListService.getTotalSongList();
        return AjaxResponse.success(totalSongList);
    }
    ...
    public AjaxResponse getSongCateGory(){
        List<StatisticsVo> listCateGory = songListService.getSongCateGory();
        return AjaxResponse.success(listCateGory);
    }
}
